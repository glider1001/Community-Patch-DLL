...
//Weight for City Target if Liberation Quest Active
	...
	GD_INT_DEF(DIPLOAI_PASSIVE_MODE_HUMANS)
	GD_INT_DEF(DIPLOAI_PASSIVE_MODE_GLOBAL)
	GD_INT_DEF(DIPLOAI_AGGRESSIVE_MODE_HUMANS)
	GD_INT_DEF(DIPLOAI_AGGRESSIVE_MODE_GLOBAL)
...
protected:
	...
	************************************************************************************************************************/
	...
	GD_INT_DECL(DIPLOAI_PASSIVE_MODE_HUMANS);
	GD_INT_DECL(DIPLOAI_PASSIVE_MODE_GLOBAL);
	GD_INT_DECL(DIPLOAI_AGGRESSIVE_MODE_HUMANS);
	GD_INT_DECL(DIPLOAI_AGGRESSIVE_MODE_GLOBAL);
